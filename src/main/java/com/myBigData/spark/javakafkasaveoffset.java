...
public final class javakafkasaveoffset {
    public static void main(String[] args) throws Exception {
        ...
        String  brokers   = "hdfsaha:9092,hdfsbha:9092,hdfscha:9092";
        String  topics    = "sg_bx_activeevent";
        String groupid   = "ddd";
        String zklist    = "hdfsaha:2181,hdfsbha:2181,hdfscha:2181";
        String datatable = "offsets2";




        SparkConf sparkConf = new SparkConf().setAppName("JavaDirectKafkaOffsetSaveToHBase").setMaster("local");
        ...
        if (isExists)
        {
            try {
                    ...
                    Filter filter = new RowFilter(CompareOp.GREATER_OR_EQUAL,new BinaryComparator(Bytes.toBytes(topics+"_")));
                    Scan s = new Scan();
                    s.setFilter(filter);
