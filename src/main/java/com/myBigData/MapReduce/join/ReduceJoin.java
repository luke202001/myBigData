...
public class ReduceJoin extends Configured implements Tool{
    ...
    public static class reduceJoinMapper extends Mapper<Object, Text, Text, CombineValues> {
    ...
    public static class reduceJoinReducer extends Reducer<Text, CombineValues, Text, Text> {
        //存储一个分组中的左表信息
    ...
    public static void main(String[] args) throws IOException,ClassNotFoundException, InterruptedException {
        try {
            int returnCode =  ToolRunner.run(new ReduceJoin(),args);
